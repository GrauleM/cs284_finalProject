...
J_sc_transpose=@(c,q,qdot,qddot,L) ...
...
for ii=1:length(c_points)
        c=c_points(ii);
        generalized_extForces_sum=generalized_extForces_sum+Fc_mags(ii)*J_sc_transpose(c,q_val,qdot_val,qddot_val,L)*Fc_direction_sc(c,q_val,qdot_val,qddot_val,L);
end
