function [line1,line2,line3]=compute_lagrange_constraints(q,q_dot,q_ddot,Ma)
...
a1=q(1); a2=q(2); a3=q(3);
a1_dt=q_dot(1); a2_dt=q_dot(2); a3_dt=q_dot(3); 
a1_dtt=q_ddot(1); a2_dtt=q_ddot(2); a3_dtt =q_ddot(3);
